...
{	//Form data sent
	$acx_onclick_popunder_service_banners = $_POST['acx_onclick_popunder_service_banners'];
	update_option('acurax_popunder_service_banners', $acx_onclick_popunder_service_banners);
	$acx_onclick_popunder_premium_ad=$_POST['acx_onclick_popunder_premium_ad'];
...
<form name="acurax_onclick_popunder_misc_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
